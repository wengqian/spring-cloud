...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String config_cfg_url="/Users/wengqian/development/workspace/wq_demo/spring-cloud-demo/visual-service-zookeeper/config.cfg";
        File f = new File(config_cfg_url);
        if (f.exists()) {
            globalProps.load(new FileInputStream(config_cfg_url));
        } else {
